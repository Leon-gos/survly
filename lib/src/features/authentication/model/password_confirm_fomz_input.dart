...
class PasswordConfirmFormzInput extends FormzInput<String, FormError> {
  const PasswordConfirmFormzInput.pure(this.password, [super.value = ""])
      : super.pure();
  const PasswordConfirmFormzInput.dirty(this.password, [super.value = ""])
      : super.dirty();
  ...
  FormError? validator(String? value) {
    ...
    if (value != password) {
      return FormError.confrimPasswordMissMatch;
    }
